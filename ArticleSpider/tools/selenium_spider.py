...
# print (browser.page_source)  #拿到js动态加载以后的页面
# browser.quit()  #关闭浏览器
...
# browser = webdriver.Chrome(executable_path="D:/Temp/chromedriver.exe",chrome_options=chrome_opt)
